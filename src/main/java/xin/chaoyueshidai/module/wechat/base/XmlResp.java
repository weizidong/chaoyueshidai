...
public class XmlResp {
	...
	public static final String buildText(String toUser, String fromUser, String content) {
		return String.format(TEXT, toUser, fromUser, time(), content);
	}
	...
	private static final String IMAGE = new StringBuilder()
			...
			.append("<FromUserName><![CDATA[%s]]></FromUserName>")
			.append("<CreateTime>%s</CreateTime>")
			.append("<MsgType><![CDATA[image]]></MsgType>")
			.append("<Image>")
	...
	public static final String buildImge(String toUser, String fromUser, String mediaId) {
		return String.format(IMAGE, toUser, fromUser, time(), mediaId);
	}
	...
	private static final String VOICE = new StringBuilder()
			...
			.append("<FromUserName><![CDATA[%s]]></FromUserName>")
			.append("<CreateTime>%s</CreateTime>")
			.append("<MsgType><![CDATA[voice]]></MsgType>")
			.append("<Voice>")
			.append("<MediaId><![CDATA[%s]]></MediaId>")
			.append("</Voice>")
			.append("</xml>").toString();
	...
	public static final String buildVoice(String toUser, String fromUser, String mediaId) {
		return String.format(VOICE, toUser, fromUser, time(), mediaId);
	}
	...
	private static final String VIDEO = new StringBuilder()
			...
			.append("<FromUserName><![CDATA[%s]]></FromUserName>")
			.append("<CreateTime>%s</CreateTime>")
			.append("<MsgType><![CDATA[video]]></MsgType>")
			.append("<Video>")
			.append("<MediaId><![CDATA[%s]]></MediaId>")
	 ...
	 * 构造视频消息响应
	 */
	public static final String buildVideo(String toUser, String fromUser, String mediaId, String title,
			String description) {
		return String.format(VIDEO, toUser, fromUser, time(), mediaId, title, description);
	}
	 ...
	 * 构造音乐消息响应
	 */
	public static final String buildMusic(String toUser, String fromUser, String title, String description,
			String musicUrl, String HQMusicUrl, String ThumbMediaId) {
		return String.format(MUSIC, toUser, fromUser, time(), title, description, musicUrl, HQMusicUrl,
				ThumbMediaId);
	}
	 ...
	 */
	public static final String buildNews(String toUser, String fromUser, List<ARTICLE> news) {
		StringBuilder sb = new StringBuilder();
		for (ARTICLE n : news) {
			sb.append(String.format(NEWSITEM, n.getTitle(), n.getDescription(), n.getPicurl(), n.getUrl()));
		}
		return String.format(NEWS, toUser, fromUser, time(), news.size(), sb.toString());
	}
	
	/**
	 * 构造图文消息内容响应(1条)
	 */
	public static final String buildNews(String toUser, String fromUser, ARTICLE news) {
		return buildNews(toUser, fromUser, Arrays.asList(news));
	}
